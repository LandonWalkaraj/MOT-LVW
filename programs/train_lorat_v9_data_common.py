"""V9-owned training-data and utility snapshot.

This file began as the mature V8 head trainer because those adapters already
handled DanceTrack/MOT-style, TAO/TAO-OW, LaSOT, selected-region, search-window,
and augmentation sampling. V9 imports this snapshot instead of importing V8 so
future V8 changes cannot silently alter V9 training behavior.

Original V8 trainer notes:
...
TrainingObject = V8TrainingObject
TrainingSample = V8TrainingSample
TrainingTargetStats = V8TrainingTargetStats
MixedFrameHeadDataset = CombinedFrameHeadDataset
